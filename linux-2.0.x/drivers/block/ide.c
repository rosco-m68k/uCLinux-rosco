...
#define CONFIG_IDE_BOOTARGS	1
#define	IDECTRL(a)		((a) ? ((a) + 0x206) : 0)
#define	ACCESS_MODE_8BIT()
#define	ACCESS_MODE_16BIT()
#define ide_fix_driveid(id)
#define	ide_interruptenable(i)
...
static void init_hwif_data (unsigned int index)
{
	...
	hwif->ctl_port  = IDECTRL(hwif->io_base);
#ifdef CONFIG_COLDFIRE
