...
extern void ide_outb(unsigned int val, unsigned int addr);
extern int ide_inb(unsigned int addr);
#define OUT_BYTE(b,p)		ide_outb((b),(p))
#define IN_BYTE(p)		(byte)ide_inb(p)
#elif defined(REALLY_FAST_IO)
