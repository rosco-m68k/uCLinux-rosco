/* 
 * linux/arch/niosnommu/kernel/sys_nios.c
 *
 * Based on:
 *
 * linux/arch/sparcnommu/kernel/sys_sparc.c
 *
 * This file contains various random system calls that
 * have a non-standard calling sequence on the Linux/nios
 * platform.
 */
...
/* Vic - FIXME - old_mmap old_select are copied from m68k */
