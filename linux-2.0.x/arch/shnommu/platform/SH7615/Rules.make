...
LIBGCC = `$(CC) -v 2>&1 | grep specs | sed -e "s/Reading specs from //" | sed -e s/specs/m2\\\/libgcc.a/`

CFLAGS := $(CFLAGS) -pipe -DNO_MM -DNO_FPU -m2  -DMAGIC_ROM_PTR -DNO_FORGET -DUTS_SYSNAME='"uClinux"'
AFLAGS := $(AFLAGS) -gstabs  -pipe -DNO_MM -DNO_FPU -m2  -DMAGIC_ROM_PTR -DUTS_SYSNAME='"uClinux"'  -Wa
